//takes full data from the prompts entered in index.js
const buildPage = data => {
    ...
    //static html used for every build
    ...
    <body>
        ...
        //card creation on a loop for manager and each additional employee added
        ...
        //if statement to add role specific icon to each card, also adds role 
                if (x.role == `Manager`) {
            ...
            <div class='card-body bg-dark-subtle'>
                ...
                //if statement used for adding role specific info
                if (x.role == `Manager`) {
...
//export built page to index.js file
